...
cp -R './build-BSRN_Toolbox-Desktop_Qt_5_9_2_clang_64bit-Release/BSRN_Toolbox.app' '../../Distribution/BSRN_Toolbox/BSRN_Toolbox.app'
...
/Developer/Qt/5.9.2/clang_64/bin/macdeployqt '../../Distribution/BSRN_Toolbox/BSRN_Toolbox.app'
