...
int MainWindow::ExpandedMeasurementsConverter( const bool b_Import, const QString& s_FilenameIn, structMethod *Method_ptr, structStaff *Staff_ptr, structStation *Station_ptr, const bool b_overwriteDataset, structDataset *Dataset_ptr, const int i_NumOfFiles )
{
    int				err										= 0;
...
// **********************************************************************************************
    ...
    if ( existsFirstFile( gi_ActionNumber, gs_FilenameFormat, gi_Extension, gsl_FilenameList ) == true )
    {
        ...
        {
            err = ExpandedMeasurementsConverter( b_Import, gsl_FilenameList.at( i ), g_Method_ptr, g_Staff_ptr, g_Station_ptr, gb_OverwriteDataset, g_Dataset_ptr, gsl_FilenameList.count() );
